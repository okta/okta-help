describe('Locale switching', () => {
  ...
  it('routes to expected URLs for H.O.C. home', () => {
  ...
  it('routes to expected URLs for ASA', () => {
  ...
  it('routes to expected URLs for Classic', () => {
  ...
  it('routes to expected URLs for Classic release notes', () => {
  ...
  it('routes to expected URLs for End User', () => {
  ...
  it('routes to expected URLs for OIE', () => {
  ...
  it('routes to expected URLs for OIE release notes', () => {
  ...
  it('routes to expected URLs for Workflows', () => {
